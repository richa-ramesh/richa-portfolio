...
export default function Publications() {
  ...
  return (
    <section id="publications-section" className="py-20 px-6 md:px-12 max-w-7xl mx-auto border-t border-slate-900/60 relative">
      <div className="absolute right-1/4 top-1/3 w-72 h-72 bg-indigo-500/5 rounded-full filter blur-3xl opacity-20 pointer-events-none" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {publications.map((pub, idx) => (
          <motion.div
            ...
            className="p-6 rounded-2xl bg-[#08090f]/90 border border-slate-900/80 hover:border-indigo-500/25 transition-all duration-300 relative flex flex-col justify-between group h-full"
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-xl bg-slate-950/80 border border-slate-900 flex items-center justify-center text-indigo-400 group-hover:scale-110 transition-transform duration-300">
                  <FileText size={18} />
                </div>
              ...
              <div className="space-y-2">
                <h3 className="text-sm md:text-base font-display font-medium text-white leading-snug group-hover:text-indigo-300 transition-colors">
                  {pub.title}
                </h3>
            ...
            {/* Bottom Info Row */}
            <div className="border-t border-slate-900/80 pt-4 mt-6 flex items-center justify-between text-[11px] font-mono text-indigo-400/80">
              <span className="text-[10px] text-slate-500 font-mono">Conference Proceedings</span>
              <div className="inline-flex items-center space-x-1 group-hover:underline">
